...
-- This migration reflects the older combined schema variant present at the
-- start of the project. For the current runtime data model used by importer-ui,
-- use sql/supabase_current_runtime_schema.sql as the canonical reference.
